...
type Repository interface {
	...
	GetByCode(ctx context.Context, code ParameterCode) (*Parameter, error)
	...
	Delete(ctx context.Context, code ParameterCode) error

	// ExistsByCode checks if a Parameter with the given code exists
	ExistsByCode(ctx context.Context, code ParameterCode) (bool, error)
}
